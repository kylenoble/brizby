...
class BusinessLoginViewController: UIViewController, UITextFieldDelegate {
  ...
  override func viewDidLoad() {
    ...
    emailAnchor = self.emailTextInputField.center.y - 18
    ...
    emailTextInputField.attributedPlaceholder = NSAttributedString(string: "email", attributes: attributesDictionary)
  ...
  {
    UIView.animateWithDuration(0.2, animations:  {
      self.emailTextInputField.center.y = self.emailAnchor
  ...
  @IBAction func loginButtonPressed(sender: UIButton) {
    ...
    Alamofire.request(Business.Router.SignIn(emailTextInputField.text, passwordTextInputField.text)).responseJSON {
      (_, _, object, _) in
